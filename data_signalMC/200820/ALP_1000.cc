...
void ALP_1000(){
	...
	// obtain rootfile
	TFile *file = new TFile("/Users/kitagawa/analysis_ALP/signalMC/diphoton.root");

	// obtain tree
	TTree* tree = (TTree*)file->Get("diphoton");
...
/****************************************************************/
	...
	double DiphotonAcoplanarity;
        tree->SetBranchAddress("TruthPhotonE1", &Energy_Photon1);
        tree->SetBranchAddress("TruthPhotonE2", &Energy_Photon2);
        tree->SetBranchAddress("TruthDiphotonM",      &Mass_ALP);
        tree->SetBranchAddress("TruthPhotonEta1",   &Eta_Photon1);
        tree->SetBranchAddress("TruthPhotonEta2",   &Eta_Photon2);
        tree->SetBranchAddress("TruthPhotonPt1",    &TransverseMomentum_Photon1);
        tree->SetBranchAddress("TruthPhotonPt2",    &TransverseMomentum_Photon2);
	tree->SetBranchAddress("TruthDiphotonAcop", 	&DiphotonAcoplanarity);
