...
*/  	diphoton->SetBranchAddress("PhotonPt1",			&MC_PhotonPt1);
	...
	/*    histogram of Acoplanarity    */
      	TH1D *MC_Acop = new TH1D("", "", 500, 0, 0.021);//0.018
...
/****************************************************************/
	...
	/*    histogram of Acoplanarity    */
      	TH1D *data_Acop = new TH1D("", "", 500, 0, 0.021);
...
/****************************************************************/
	//histogram of TH2D
      	//TH2D *significance_DiphotonAcop = new TH2D("", "", 15, 0, 0.0225, 300, 0, 30);
...
/*	double end_DiphotonAcop = 0.022;
	...
	TGraph *significance_DiphotonAcop = new TGraph(sig_n); 
      	...
      	significance_DiphotonAcop->SetTitle(" ; DiphotonAcop; significance");
	//significance(signal/sqrt(data=background)) in the range  DiphotonAcop < 0.002
...
//	long int hist_MC0 = outputTree_1->GetEntries("MC_DiphotonAcop < 0.01");

//	long int hist_data0 = outputTree_2->GetEntries("data_PhotonAcop < 0.01");
	...
	//significance_DiphotonAcop->Fill(start_DiphotonAcop, significance);
	
	//Fill to Tgraph
	significance_DiphotonAcop->SetPoint(sig_i, start_DiphotonAcop, significance);
