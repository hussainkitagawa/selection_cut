...
void ALP_1000(){
	...
	// Set output file
        ...
        TTree* outputTree = new TTree("alp_1000GeV", "data_MC");
...
/****************************************************************/
	...
	//histogram of Acoplanarity  
        //TH1D* Generator_Acop_1000GeV= new TH1D("", "", 540, 0, 0.0216);//binning size is 4e-5
...
//Set parameters for Loop
        ...
        //histogram of TGraph :: Calculate significance for each ALP mass for 1000GeV 
	...
	double optimized_data_events;
		...
		data_events = 200 * MC_ibin;//background is constant according to Invariant Mass>=1000GeV
