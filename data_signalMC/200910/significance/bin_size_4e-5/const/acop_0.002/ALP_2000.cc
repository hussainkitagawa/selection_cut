...
void ALP_2000(){
	...
	// obtain tree
        TTree* tree	 = (TTree*)file->Get("alp_2000GeV");

	// Set output file
        TFile* outputFile = new TFile("significance_data.root", "recreate");
        TTree* outputTree = new TTree("alp_2000GeV", "data_MC");
...
/****************************************************************/
	...
	tree->SetBranchAddress("2000GeV_Energy_ALP", 	&Energy_ALP);
	tree->SetBranchAddress("2000GeV_Energy_Photon1", &Energy_Photon1);
	tree->SetBranchAddress("2000GeV_Energy_Photon2", &Energy_Photon2);
	tree->SetBranchAddress("2000GeV_Mass_ALP", 	&Mass_ALP);
	tree->SetBranchAddress("2000GeV_Mass_Photon1", 	&Mass_Photon1);
	tree->SetBranchAddress("2000GeV_Mass_Photon2", 	&Mass_Photon2);
	tree->SetBranchAddress("2000GeV_Theta_Photon1", 	&Theta_Photon1);
	tree->SetBranchAddress("2000GeV_Theta_Photon2", 	&Theta_Photon2);
	tree->SetBranchAddress("2000GeV_Eta_Photon1", 	&Eta_Photon1);
	tree->SetBranchAddress("2000GeV_Eta_Photon2", 	&Eta_Photon2);
	tree->SetBranchAddress("2000GeV_TransverseMomentum_Photon1", 	&TransverseMomentum_Photon1);
	tree->SetBranchAddress("2000GeV_TransverseMomentum_Photon2", 	&TransverseMomentum_Photon2);
	tree->SetBranchAddress("2000GeV_Acoplanarity", 	&DiphotonAcoplanarity);
		



	//histogram of Acoplanarity  
        //TH1D* Generator_Acop_2000GeV= new TH1D("", "", 540, 0, 0.0216);//binning size is 4e-5
       ...
       /**********   Start main Loop of Generator level with 2000 GeV ALP mass(ALP_GeneratorMC.root)   **********/
...
/****************************************************************/
	...
	GeneratorMC_Acop->Sumw2();// Sumw2 has to be done before Scale()
        ...
        cout<< "####################  Generator MC(2000GeV)  ####################"<<endl;
        cout<< ""<<endl;
        ...
        cout<< "Expected MC events(2000GeV);     " << expected_MC << '\n';
...
//Set parameters for Loop
        ...
        //histogram of TGraph :: Calculate significance for each ALP mass for 2000GeV 
	...
	double optimized_data_events;
		...
		data_events = 200 * MC_ibin;//background is constant according to Invariant Mass>=2000GeV
...
/****************************************************************/
	...
	//Significance
	TCanvas *c2000 = new TCanvas("c2000", "c2000");
	significance_DiphotonAcop->Draw("AP");
    	c2000->Modified();
	c2000->SetWindowSize(830, 550);
